        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Software & Web</h4>
              <p>
                Build full-stack web solutions using Python, Flask, Firebase, and
                MySQL while applying strong problem-solving and collaboration skills.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Designed UI/UX assets with Canva and incorporated AI-based tools
                for analytics, predictive insights, and branded digital experiences.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
